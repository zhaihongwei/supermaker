...
$sql = "select commodity_id,count from my_commodity_car where user_phone='$user_phone' and commodity_id='$commodity_id'";
...
if($output){
	...
	//update数据
 	 $count2 = $output['count']+$count;
 	 // echo $count2;
     $sql2 = 'SET NAMES utf8';
     mysqli_query($conn, $sql2);
$sql2 = "update my_commodity_car set count='$count2' where user_phone= '$user_phone' and commodity_id='$commodity_id'";
