...
if(empty($user_phone) || empty($commodity_id) || empty($count)|| empty($user_name)|| empty($user_addr)){
	$data['msg'] = 'error';
	$data['reason'] = "提交信息不足";
...
$sql = "INSERT INTO my_commodity_order VALUES('$user_phone','$commodity_id','$order_time','$count')";
